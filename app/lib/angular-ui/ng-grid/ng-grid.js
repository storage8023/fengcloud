...
angular.module("ngGrid").run(["$templateCache", function($templateCache) {
  ...
  $templateCache.put("gridTemplate.html",
    ...
    "        </ul>" +
    "    </div>" +
    "    <div class=\"file_list_header ngHeaderContainer\" ng-style=\"headerStyle()\">" +
    ...
    "        <div class=\"file_item\" ng-dblclick=\"handleDblClick($event,row.entity)\" ng-style=\"rowStyle(row)\" ng-repeat=\"row in renderedRows\" ng-click=\"row.toggleSelected($event)\" ng-class=\"row.alternatingRowClass()\" ng-row></div>" +
    "    </div>" +
    "</div>" +
