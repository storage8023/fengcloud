...
var guiders = (function($) {
  ...
  guiders._arrowSize = 11; // This is the arrow's width and height.
  guiders._backButtonTitle = "Back";
  guiders._buttonAttributes = {"href": "javascript:void(0);"};
  guiders._buttonClassName = "btn btn-primary"; // Override this if you use a different class name for your buttons.
